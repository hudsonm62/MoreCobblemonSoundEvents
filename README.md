# More Cobble Sound Events

More Cobble Sound Events adds a collection of extra Cobblemon sound events, making it easier for resource pack and modpack creators to customize audio.
...
```text
assets/morecobblesoundevents/sounds.json
```

Then define the sound events you want to override or provide. For example:

```jsonc
// CoolResourcePack/assets/morecobblesoundevents/sounds.json
{
...
```text
src/main/resources/assets/morecobblesoundevents/sounds.json
```
